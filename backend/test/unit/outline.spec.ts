        ...
        if (callCount === 1) {
          ...
          return {
            text: JSON.stringify({
              ...
              sections: [
                { heading: "Introduction", purpose: "Cover the basics.", keyFacts: ["Fact 1"], example: "Intro Ex", transition: "Next A", targetWordCount: 150 },
                { heading: "Advanced Topics", purpose: "Deep dive.", keyFacts: ["Fact 2"], example: "Deep Ex", transition: "Next B", targetWordCount: 150 },
                { heading: "Examples", purpose: "Real-world cases.", keyFacts: ["Fact 3"], example: "Real Ex", transition: "Next C", targetWordCount: 150 },
                { heading: "Limitations", purpose: "Challenges faced.", keyFacts: ["Fact 4"], example: "Lim Ex", transition: "Next D", targetWordCount: 150 }
              ]
            }),
      ...
      async (args: any) => {
        ...
        return {
          text: JSON.stringify({
            ...
            hook: "Outline Hook",
            sections: [
              { heading: "Section 1", purpose: "P1", keyFacts: ["Fact 1"], example: "Ex 1", transition: "T1", targetWordCount: 150 },
              { heading: "Section 2", purpose: "P2", keyFacts: ["Fact 2"], example: "Ex 2", transition: "T2", targetWordCount: 150 },
              { heading: "Section 3", purpose: "P3", keyFacts: ["Fact 3"], example: "Ex 3", transition: "T3", targetWordCount: 150 },
              { heading: "Section 4", purpose: "P4", keyFacts: ["Fact 4"], example: "Ex 4", transition: "T4", targetWordCount: 150 }
            ]
          }),
